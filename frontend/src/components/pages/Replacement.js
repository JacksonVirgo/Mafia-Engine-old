...
function ReplacementForm() {
    ...
    return (
        <form className={styles.modalForm} onSubmit={onSubmit}>
            <label className={styles.modalLabel} htmlFor="gameThread">
                Link to Game Thread
            </label>
            <input className={styles.modalInput} id="gameThread" name="gameThread" type="text" />
            <br />
            <label className={styles.modalLabel} htmlFor="departingPlayer">
                Departing Player
            </label>
...
export default function Replacement() {
    return <CenterModal title="Replacement Form" child={<ReplacementForm />} />;
}
